<div class="fixed bg-[#0d0d0d] h-screen w-64 flex flex-col items-center justify-between z-50">
    <div class="w-full">
        ...
        <div class="w-full bg-[#000000] flex flex-col gap-4 items-center py-4">
            ...
            <a href="{{ route('gd.gamepage') }}" class="text-white p-2 px-12 rounded-full hover:scale-105 transition-all {{ Request::is('dashboard/gamepage') ? 'bg-[#f91f2e]' : 'bg-[#f90617]'}}"><i
                    class="fa-solid fa-tags mr-2"></i>Game Page</a>
